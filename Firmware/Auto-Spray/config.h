...
// ПИНЫ
// -----------------------------------------------------------
#define PIN_MODE A0         // Переключатель режима (LOW = авто)
...
#define SPRAY_PAUSE1_MS 50UL    // пауза между реверсом двигателя (мс)
#define SPRAY_REVERSE_MS 500UL  // длительность реверса двигателя (мс)
#define SPRAY_PAUSE2_MS 200UL   // пауза между пшиками (мс)
...
#define STARTUP_DELAY_MS 200     // Время включения каждого светодиода при старте для проверки
