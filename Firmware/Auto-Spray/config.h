...
// -----------------------------------------------------------
#define VCC_ARDUINO 3000                  // напряжение питания Ардуино (мВ)
#define BATTERY_DIVIDER_RATIO 1.47f       // коэффициент делителя
#define BATTERY_LOW_VOLTAGE_MV 3000UL     // порог: 3.0 В
#define BATTERY_CHECK_INTERVAL_MS 5000UL  // раз в 5 сек
#define BATTERY_LED_ON_MS 100UL           // длительность вспышки
#define BATTERY_LED_OFF_MS 500UL         // период
