...
#define LIGHT_READY_MS (LIGHT_READY_MINUTES * 60UL * 1000UL)  // Время, которое свет должен быть включён, прежде чем устройство перейдёт в режим READY
#define BLOCK_MS (BLOCK_MINUTES * 60UL * 1000UL)              // Время блокировки после распыления
