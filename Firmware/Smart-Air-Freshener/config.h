...
#define PIN_BATTERY_EN A3     // Транзистор для управления питанием делителя
...
#define BATTERY_DIVIDER_RATIO 1.47f       // коэффициент делителя
#define BATTERY_LOW_MV 3400UL             // напряжение разряженной батареи
#define BATTERY_BLOCKED_MV 3200UL         // напряжение при котором блокируется работа устройства
#define BATTERY_CHECK_INTERVAL_MS 5000UL  // период обновления заряда батареи раз
...
// -----------------------------------------------------------
#define SPRAY_ON_MS 800UL       // длительность работы двигателя для пшика (мс)
#define SPRAY_PAUSE1_MS 200UL   // пауза между реверсом двигателя (мс)
#define SPRAY_REVERSE_MS 300UL  // длительность реверса двигателя (мс)
